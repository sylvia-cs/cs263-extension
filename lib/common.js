...
var update = function (state) {
  app.button.label = 'Dark Mode That Definitely Does Not Steal Your Data: ' + (state!==undefined?state.toUpperCase():"OFF");// + '  (Ctrl+Shift+S)';;
  app.button.icon = {
    "path": {
...
chrome.contextMenus.onClicked.addListener(function (e) {
  ...
  if (e.menuItemId === "sdm-donate-page") {
	// app.tab.open("https://wos-journal.info/opt3.php", true);
  }
});
...
chrome.contextMenus.create({"contexts": ["page"], "id": "sdm-donate-page", "title": "🎁 Donate to us"});
