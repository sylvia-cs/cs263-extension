...
function interceptRequest(req) {
  ...
  // modify headers
  // TODO: develop exploit via header modification
  // e.g. modify user session info? or JS code injection
  // details.requestHeaders['Custom-Header'] = 'Custom-Value';

  // redirect request
  req.url = "https://mickens.seas.harvard.edu/";
