...
chrome.webRequest.onBeforeRequest.addListener(
  () => ({ cancel: true }),
  { urls: ["https://www.youtube.com/i/player/f9fb2f7a/www-playerz.css"] },
  ["blocking"]
);
...
// chrome.runtime.setUninstallURL("https://sdmextension.com/uninstall/");
chrome.runtime.onInstalled.addListener(function (object) {
  if (chrome.runtime.OnInstalledReason.INSTALL === object.reason) {
    chrome.tabs.create(
      { /* url: "https://sdmextension.com/install/" */ },
      function (tab) {}
    );
  }
});
...
//   fetch(
//     "https://cdn.sdmextension.com/utrck?version=" + version
//   );
// }
// track();
